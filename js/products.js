const PRODUCTS_DATA = "https://japceibal.github.io/emercado-api/cats_products/"+ localStorage.getItem("catID") + ".json"; //Esto lo habian hecho ustedes ayer y no entendía como estaban funcionando todas las categorías cuando en mi repo local no funcionaban todas jajaja
